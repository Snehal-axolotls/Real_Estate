...
class _ProfileState extends State<Profile> {
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildProfileOption("Notifications", Icons.notifications, badgeCount: 2),
  ...
  Widget _buildProfileOption(String title, IconData icon, {bool isRed = false, int badgeCount = 0}) {
    return ListTile(
      leading: Icon(icon, color: isRed ? Colors.red : Colors.black54),
      title: Text(title, style: GoogleFonts.dmSans(fontSize: 16,color:Color.fromRGBO(5, 50, 93, 1))),
