...
class _AssignedLeadsState extends State<AssignedLeads> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, String>> filteredLeads = leads.where((lead) {
      bool matchesStatus =
                  ...
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (context) => filters
                        .map((filter) => PopupMenuItem(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.circle,
                                      color: getStatusColor(filter), size: 12),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.circle,
                              color: getStatusColor(selectedFilter), size: 12),
                          const SizedBox(width: 8),
                          Text(selectedFilter,
                              style: GoogleFonts.dmSans(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return leadCard(lead['name']!, lead['phone']!,
                    lead['interest']!, lead['status']!, lead['followUp']!);
              },
            ),
          ),
        ],
  ...
  Widget leadCard(String name, String phone, String interest, String status,
      String followUp) {
    return Card(
            ...
            Row(
              children: [
                const Icon(Icons.phone_in_talk,
                    color: Color.fromRGBO(255, 193, 0, 1), size: 13),
                const SizedBox(
                  width: 10,
                ),
                Text("Phone             :",
            ...
            Row(
              children: [
                const Icon(Icons.house_rounded,
                    color: Color.fromARGB(255, 241, 120, 111), size: 13),
                const SizedBox(
                  width: 10,
                ),
                Text("Interested In  :",
            ...
            Row(
              children: [
                const Icon(Icons.assessment_outlined,
                    color: Color.fromRGBO(57, 131, 71, 1), size: 13),
                const SizedBox(
                  width: 10,
                ),
                Text("Status             :",
            ...
            Row(
              children: [
                const Icon(Icons.calendar_month,
                    color: Color.fromRGBO(117, 165, 234, 1), size: 13),
                const SizedBox(
                  width: 10,
                ),
                Text("Follow Up       :",
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.call,
                              color: Color.fromRGBO(9, 67, 124, 1), size: 8),
                          const SizedBox(
                            width: 5,
                          ),
                          Text("Call",
                                              ...
                                              child: Row(
                                                children: [
                                                  Icon(Icons.calendar_month,
                                                      color: Color.fromRGBO(8,72,134,1),),
                                                  SizedBox(width: 8),
                                                  Column(
                                                    crossAxisAlignment:
                                                        CrossAxisAlignment
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        ...
                                                        style: TextStyle(
                                                          ...
                                                          fontWeight:
                                                              FontWeight.bold,
                                                          color: Color.fromRGBO(189, 201, 221, 1),
                                                        ),
                                                      ),
                                                    ],
                                                  ),
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              decoration:BoxDecoration(
                                                ...
                                                border:Border.all(color:Color.fromRGBO(189, 201, 221, 1))
                                              ),
                                              child:Text("Note", style: GoogleFonts.dmSans(
                                                                                fontWeight: FontWeight.w500,
                                                                                fontSize: 11,
                                                                                color: const Color.fromRGBO(189,201,221,1),
