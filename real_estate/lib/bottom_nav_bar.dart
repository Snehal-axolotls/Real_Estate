...
import 'package:real_estate/assigned_lead.dart';
import 'package:real_estate/dashboard.dart';
...
class _CustomBottomNavBarState extends State<CustomBottomNavBar> {
  ...
  List<String> labels = ["Dashboard", "Leads", "Properties", "Follow ups", "Profile"];
  List<IconData> icons = [
