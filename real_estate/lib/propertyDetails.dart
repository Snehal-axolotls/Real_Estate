                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(children: [
                      SvgPicture.asset("assets/svg/urban_city.svg",height: 100,width: 100,),
                      Row(
                        children: [
                          Text(
                            "2BHK Apartment",
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Icon(Icons.circle,color: Color.fromRGBO(34, 85, 134, 1),size: screenWidth*0.015,),
                                            ),
                                            ...
                                            Expanded(
                                              child: Text(
                                                " : ${entry.value}",
                                                style: GoogleFonts.dmSans(
                                                  color: Color.fromRGBO(92, 106, 119, 1),
                                                  fontWeight: FontWeight.w400,
                                                  fontSize: screenWidth*0.03,
                                                ),
                                              ),
